...
class ConsejoeconomicoController extends Controller
{
    /**
    ...
    public function index() {
        $consejos = Consejo::where('tipo', 'ECONÓMICO')->get();
        if (count($consejos) > 0) {
        ...
        return view('administracion.consejo_economico.list')
    ...
    public function create() {
        ...
        return view('administracion.consejo_economico.create')
            ->with('location', 'administracion')
            ->with('personas', $datos)
            ->with('admins', $array);
    }
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('consejoeconomico.index');
    }
