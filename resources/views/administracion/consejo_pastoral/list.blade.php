...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
        ...
        <li class="active"><a href="{{route('consejopastoral.index')}}">Consejo Pastoral</a></li>
    </ol>
@endsection
@section('content')
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2>
                        ADMINISTRACIÓN - CONSEJO PASTORAL<small>Haga clic en el botón de 3 puntos de la derecha de
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="{{ route('consejopastoral.create') }}">Agregar Nuevo Registro</a></li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong>Gestione los diferentes miembros del consejo pastoral para una administracion.
                </div>
