        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <form class="form-horizontal" method="POST" action="{{route('consejopastoral.store')}}">
                                @csrf
                                <div class="col-md-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Agregue nuevos miembros al consejo pastoral,</strong> Gestione los diferentes miembros del consejo pastoral para una administracion.
                </div>
