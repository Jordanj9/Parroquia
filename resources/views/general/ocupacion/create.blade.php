...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
        ...
        <li class="active"><a>Crear Ocupación</a></li>
    </ol>
@endsection
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <h1 class="card-inside-title">DATOS DE LA OCUPACIÓN</h1>
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <form class="form-horizontal" method="POST" action="{{route('ocupacion.store')}}">
                                @csrf
                                <div class="col-md-12">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <br/><textarea type="text" class="form-control"
                                                               placeholder="Descripción de la ocupación (Opcional)"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Agregue nuevas ocupaciones,</strong> Gestione la información de las diferentes
                    ocupaciones.
                </div>
