...
@section('breadcrumb')
    <ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
        ...
        <li class="active"><a>Crear Situación Espiritual</a></li>
    </ol>
@endsection
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <h1 class="card-inside-title">DATOS DE LA SITUACIÓN ESPIRITUAL</h1>
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <form class="form-horizontal" method="POST" action="{{route('situacionespiritual.store')}}">
                                @csrf
                                <div class="col-md-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="defaultModalLabel">SOBRE LA SITUACIÓN ESPIRITUAL</h4>
                </div>
                <div class="modal-body">
                    <strong>Agregue nuevas situaciones espirituales,</strong> Gestione la información de las diferentes
