    ...
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2>
                        GENERAL - PARROQUIAS<small>Haga clic en el botón de 3 puntos de la derecha de este
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="{{ route('parroquia.create') }}">Agregar Nueva Parroquia</a></li>
                            ...
                            @foreach($parroquias as $parroquia)
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a href="{{ route('parroquia.delete',$parroquia->id)}}"
