...
<ol class="breadcrumb breadcrumb-bg-blue-grey" style="margin-bottom: 30px;">
    ...
    <li class="active"><a>Crear nuevo talleristas</a></li>
</ol>
@endsection
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <form class="form-horizontal" id="form-talleristas" method="POST" action="{{route('talleristas.store')}}">
                            @csrf
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <label for="">IDENTIFICACIÓN</label>
                                        <br/><input type="text" id="identificacion"  class="form-control" placeholder="numero de identificación" name="identificacion" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><input type="text" id="nombres" class="form-control" placeholder="Escriba el nombre completo del tallerista" name="nombres" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><input type="date" class="form-control" placeholder="Escriba el nombre del programa de apoyo" name="fecha_de_nacimiento" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><input type="number" class="form-control" placeholder="Numero de contacto" name="celular" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><input type="email" class="form-control" placeholder="Correo institucional de contacto" name="correo_institucional" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><input type="email" class="form-control" placeholder="Correo personal de contacto" name="correo_personal" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <br/><input type="number" min="0" max="40" class="form-control" placeholder="Correo personal de contacto" name="numero_horas_semanales" required="required" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
    ...
    <script type="text/javascript">
        ...
        function guardar(event) {
            ...
            $.ajax({
                ...
                if (msg.status  ==  'ok') {
                    notify('Atención', 'El tallerista.' + $("#identificacion").val() + ' - ' + $("#nombres").val() + ' fue creada con exito.!', 'success');
