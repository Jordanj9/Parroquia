    ...
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    <h2>
                        GENERAL - SACRAMENTOS<small>Haga clic en el botón de 3 puntos de la derecha de este
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="{{ route('sacramentos.create') }}">Agregar Nuevo Sacramento</a></li>
                        ...
                        <table id="tabla"
                            ...
                            @foreach($sacramentos as $sacramento)
                                <tr>
                                    ...
                                    <td>{{$sacramento->descripcion}}</td>
                                    <td style="text-align: center;">
                                        <a href="{{ route('sacramentos.edit',$sacramento->id)}}"
                                           class="btn bg-indigo waves-effect btn-xs" data-toggle="tooltip"
                                           data-placement="top" title="Editar Sacramento"><i
                                                class="material-icons">mode_edit</i></a>
                                        <a href="{{ route('sacramentos.delete',$sacramento->id)}}"
                                           class="btn bg-red waves-effect btn-xs" data-toggle="tooltip"
                                           data-placement="top" title="Eliminar Sacramento"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong>Gestione la información de las diferentes sacramentos de la iglesia.
                </div>
