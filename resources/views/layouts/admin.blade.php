...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('inicio')}}">{{ config('app.name') }} - Nuestra Señora Del Rosario</a>
        </div>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                @if(session()->exists('MOD_PASTORAL'))
                    @if($location=='pastoral')
                        <li class="active"><a href="{{route('admin.pastoral')}}"><i
                                    class="material-icons">description</i><span>Pastoral</span></a></li>
                    @else
                        <li><a href="{{route('admin.pastoral')}}"><i
                                    class="material-icons">description</i><span>Pastoral</span></a></li>
                    @endif
                @endif
                @if(session()->exists('MOD_ADMINISTRACION'))
                    @if($location=='administracion')
                        <li class="active"><a href="{{route('admin.administracion')}}"><i
                                    class="material-icons">layers</i><span>Administración</span></a></li>
                    @else
                        <li><a href="{{route('admin.administracion')}}"><i
        ...
        <div class="legal">
            <div class="copyright">
                ...
                <div class="version">
                    <b>Desarrollado Por: </b> <a href="#">Jordan Cuadro</a>
                </div>
            </div>
            <!-- #Footer -->
    </aside>
